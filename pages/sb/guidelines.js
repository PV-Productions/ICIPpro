    ...
    <>
      <SBLayout>
        ...
        >
          ...
          <div className="textG">
            General Instructions 1. Prepare the paper in Latex/ MS word and
            submit the PDF copy. 2. Check the spelling mistakes using spell
            check. All papers must conform, at time of submission, to the IEEE
            ...
            with 1.7cm margins on all sides. Points to note on formatting your
            MS Word file Files should be in MS Word format only and should be
            ...
            separately. Please make sure that you use as much as possible normal
            ...
            errors. Paper structure Papers should be prepared in the following
            order: Introduction: to explain the background work, the practical
            applications and the nature and purpose of the paper. Body: to
            contain the primary message, with clear lines of thought and
            validation of the techniques described. Conclusion Acknowledgements
            (when appropriate) References Appendices (when appropriate) Section
            headings: should be left justified, with the first letter
            ...
            justified, with second and subsequent lines indented. 3. Formatting
            your document Please do not alter the formatting and style layouts
            ...
            file â€œMS Word Templateâ€ with the appropriate name supplied. i.
            Title page The first page should include: (a) Title Click on the
            ...
            details. (c) Abstract (50-100 words) Insert an abstract of 50-100
            words, giving a brief account of the most relevant aspects of the
            paper. (e) Keywords (5-10) Insert 5-10 keywords. Please follow the
            template style for all the above features. ii. Tables All tables
            ...
            embedded into the text and not supplied separately. iii.
            Illustrations All figures should be numbered with Arabic numerals
            ...
            each other to save space. iv. Equations Equations and formulae
            ...
            from the surrounding text by one space. v. References In the text
            ...
            listed according to the sequential numeric system: [1] G. Eason, B.
            ...
            London, vol. A247, pp. 529-551, April 1955. [2] J. Clerk Maxwell, A
            Treatise on Electricity and Magnetism, 3rd ed., vol. 2. Oxford:
            Clarendon, 1892, pp.68-73. [3] I. S. Jacobs and C. P. Bean, â€œFine
            particles, thin films and exchange anisotropy,â€ in Magnetism, vol.
            III, G. T. Rado and H. Suhl, Eds. New York: Academic, 1963, pp.
            271-350. vi. Footnotes Footnotes should be avoided if possible.
            ...
            in the footnote falling outside printing range. vii. General
            ...
            when first mentioned, or a glossary provided. 4. Online licence
            transfer IEEE policy requires that prior to publication all authors
            ...
            for publication. 5. In conclusion We wish you success with your
