    ...
    return (
        <div className="wrapperS" style={{width:(wWidth>560?"80vw":"100vw"),float:"right"}}>
            ...
            <div className="one" style={{width:(wWidth>560?"40%":"80%")}}>
                <img width={wWidth>560?"300":"180"} height="180" src="/logo2Artboard 1PNG.png"></img>
                <h3>Computing Professionals <br/> Charitable Trust (CPCT),
                Bangalore.</h3> 
            </div>
            
            <div className="one" style={{width:(wWidth>560?"40%":"80%")}}>
                <img width={wWidth>560?"300":"180"} height="180" src="https://www.icipbangalore.org/images/ieee_blr_section.png"></img>
                <h3>IEEE Bangalore Section</h3> 
            </div>
            <div className="one" style={{width:(wWidth>560?"40%":"80%")}}>
                <img width={wWidth>560?"300":"180"} height="180" src="/logo3Artboard 1PNG.png"></img>
